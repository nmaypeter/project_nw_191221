            ...
            for prod_setting in prod_seq:
                ...
                for times in range(10):
                    ...
                    for wd in wd_seq:
                        ...
                        # Model('mdag1Mepw_' + str(times), dataset_name, product_name, cascade_model, wallet_distribution_type).model_dag(1, r_flag=True, epw_flag=True, M_flag=True)
                        # Model('mdag2Mepw_' + str(times), dataset_name, product_name, cascade_model, wallet_distribution_type).model_dag(2, r_flag=True, epw_flag=True, M_flag=True)
